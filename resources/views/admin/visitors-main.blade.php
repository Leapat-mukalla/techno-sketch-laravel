                ...
                <table class="table  v-middle mb-0 ">
                    <thead>
                        <tr class="border-0">
                            ...
                            <th class="border-0 font-14 font-weight-medium text-dark px-2">الجوال</th>
                            <th class="border-0 font-14 font-weight-medium text-dark px-2">البريد الإلكتروني</th>
                            <th class="border-0 font-14 font-weight-medium text-dark px-2">العمر </th>
                            <th class="border-0 font-14 font-weight-medium text-dark px-2">الجنس </th>
                            <th class="border-0 font-14 font-weight-medium text-dark px-2">العنوان </th>
                            <th class="border-0 font-14 font-weight-medium text-dark px-2">الحالة</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border-top-0 border-bottom-0  px-2 py-4 font-14">{{$user->name}}</td>
                            <td class="border-top-0 border-bottom-0  px-2 py-4 font-14">{{$user->phone}}</td>
                            <td class="border-top-0 border-bottom-0 px-2 py-4 font-14">{{$user->email}}</td>
                            <td class="border-top-0 border-bottom-0  px-2 py-4 font-14">{{ $user->VisitorsData->age }}</td>
                            <td class="border-top-0 border-bottom-0  px-2 py-4 font-14">{{ $user->VisitorsData->gender }}</td>
                            <td class="border-top-0 border-bottom-0  px-2 py-4 font-14">{{ $user->VisitorsData->address }}</td>
                            <td class="border-top-0 border-bottom-0  px-2 py-4 font-14">{{ $user->VisitorsData->status }}</td>
