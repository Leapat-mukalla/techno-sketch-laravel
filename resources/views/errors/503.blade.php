...
<head>
    <title>503 الخدمة غير متوفرة</title>
    <!-- Favicon icon -->
    ...
    <section class="py-3 py-md-5 min-vh-100 d-flex justify-content-center align-items-center">
        ...
        <div class="row">
            ...
            <div class="text-center text-black">
                <h2 class="d-flex justify-content-center align-items-center gap-2 mb-4" style="direction: ltr !important">
                ...
                <p class="mb-5 mt-3 h3">الخادم غير قادر حاليًا على التعامل مع الطلب بسبب التحميل الزائد المؤقت أو صيانة الخادم.</p>
